...
import { DishDetail, DishFormRefs, IngredientOption, IngredientCategory } from "@/app/components/dish-form/types";
...
export default function EditDishPage() {
  ...
  useEffect(() => {
    const fetchAll = async () => {
      try {
        const [dishRes, cRes, catRes, netRes, minorRes, ingRes, sauceRes] = await Promise.all([
        ...
        setDish(dishJson.data || dishJson);
        setRefs({
